...
public class ClipboardMonitorService extends Service {
    ...
    protected void createDatabase(){
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS Copied(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,textcopied VARCHAR);");
    }
    @Override
        ...
        public void run() {
            ...
            if (isExternalStorageWritable()) {
                try {
                    ...
                    writer.newLine();
                    writer.close();
                    String i=mTextToWrite.toString();
                    i=i.replace("'","''");
                    String query = "INSERT INTO Copied (textcopied) VALUES('"+i+"');";
                    db.execSQL(query);
